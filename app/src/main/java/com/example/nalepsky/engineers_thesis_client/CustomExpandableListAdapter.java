...
public class CustomExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private List<EntryWithUnitNamesAndId> expandableListTitle;
    private LinkedHashMap<EntryWithUnitNamesAndId, List<UnitNameAndId>> expandableListDetail;

    public CustomExpandableListAdapter(Context context, List<EntryWithUnitNamesAndId> expandableListTitle,
